...
const projects: Project[] = [
  {
    ...
    slug: 'ts-snippets',
    title: 'ts-snippets',
    summary: 'A chrome extension to save, compile, run, and manage TypeScript snippets',
  ...
  },
  {
    ...
    slug: 'starfleet',
    title: 'STARFLEET',
    summary: "A thrilling and visually captivating gaming experience, STARFLEET is ...",
  ...
  summary: "A Premier Resource for Underground Event in New York",
  info: "",
...
},
{
  ...
  slug: 'tripshare',
  title: 'tripShare',
  summary: 'share and inspire others with your experiences',
  info: "Explore captivating journeys and share your own. Dive into the world's favorite destinations.",
